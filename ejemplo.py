...
usuarios_lista = ["naomi.camas","angelo.la.madrid", "abel.huamani", "jefferson.mauricio", "gian.nuñez", "pedro.porras", "erick.portuguez", "jhon.sotomayor", "carlos.hernandez", "jonny.silverhand", "diego.sanchez", "valeria.ramirez"]
...
while True:
    ...
    soles = float(input("\nIngrese la cantidad de SOL COINs a enviar: "))
